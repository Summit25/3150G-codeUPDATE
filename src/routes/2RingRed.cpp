...
void test3() {
    ...
    MoveEncoderPID(TestPara, 40, 17, 0.5, 0, true);
    Clamp.set(true);
    wait(200, msec);
    RunRoller(100);
    wait(100, msec);
    TurnMaxTimePID(TestPara, 120, 0.4, true);
    MoveEncoderPID(TestPara, -70, 25, 0.4, 120, true);
    MoveEncoderPID(TestPara, 70, 14, 0.4, 120, true);
    wait(100, msec);
    TurnMaxTimePID(TestPara, -20, 0.4, true);
    MoveEncoderPID(TestPara, -70, 36, 0.4, -20, true);
    RunRoller(0);
    TurnMaxTimePID(TestPara, -67, 0.4, true);
    MoveEncoderPID(TestPara, -70, 21, 0.4, -67, true);
    Clamp.set(false);
    MoveEncoderPID(TestPara, -70, 5, 0.4, -67, true);
    TurnMaxTimePID(TestPara, 53, 0.4, true);
    MoveEncoderPID(TestPara, 80, 20, 0.4, 53, true);
    MoveEncoderPID(TestPara, 40, 10, 0.5, 53, true);
    Clamp.set(true);
    wait(200, msec);
    TurnMaxTimePID(TestPara, -67, 0.4, true);
    RunRoller(100);
